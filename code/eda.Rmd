...
It is important the training data is not affected by SMOTE, but the test
...
## NaiveBayes
Performing NaiveBayes on the SMOTE dataset provides an accuracy of 81.05%. This
is already more accurate than simply performing a ZeroR.